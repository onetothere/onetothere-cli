...
const createCommands = () => {
  ...
  program
    .command('addcpn <name>')
    .description('add vue component, For example: onetothere addcpn NavBar [-d src/components]')
    .action(name => addComponent(name, program.dest || 'src/components'))

  program
    .command('addpage <name>')
    .description('add vue page, For example: onetothere addpage Home [-d dest]')
    .action(name => {
  ...
  program
    ...
    .description('add vue store, For example: onetothere addstore favor [-d dest]')
    .action(name => {
